...
## Ultra96 v1與v2的差異
因為v1跟v2在LPDDR4上的選料有很大的不一樣，因此FSBL的設定上會不一樣，故無法共用相同開機檔案或是SD images，後續再來談此主題。先來看看v1跟v2的差別：
...
從外觀上來比較，尺寸大小是一樣的，除了很明顯Wi-Fi/Bluetooth的module從TI改成Microchip外，另外Power on/off的按鍵位置也很明顯不一樣。如下圖紅色圈圈處
![](https://i.imgur.com/podTvIo.jpg)
另外，v1及v2除了在FSBL配置上不一樣外，其餘的開發流程是一樣了，因此幾乎所有的參考設計，只要重新rebuild後都可以用。由於v1已經宣告EOL了，故此系列文章將會以Ultra96 v2為主。有關Ultra96 v1的開箱文可以參考[clodnew's blog](https://coldnew.github.io/f4865ec/).
