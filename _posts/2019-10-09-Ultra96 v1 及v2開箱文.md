...
![figure](images/20191008/ultra96-combi.png)
...
![figure](images/20191008/IMG_1474.jpg)
...
![figure](images/20191008/IMG_1475.jpg)
...
![figure](images/20191008/Etcher.png)

### 重新開機
按下power on按鍵後，大約2秒左右Done LED(藍燈)亮起，大約18秒左右顯示螢幕會出現Linux開機畫面，大約50秒左右整個Linux GUI開機完成，表示整個SD Image燒錄成功。
![figure](images/20191008/IMG_1476.jpg)

螢幕顯示畫面
![figure](images/20191008/IMG_1477.jpg)
...
![figure](images/20191008/pw.png)
登入後首頁
![figure](images/20191008/Jupyter_notebook_1.png)
進入common目錄內，點擊wifi.ipynb測試網路連線
![figure](images/20191008/Jupyter_notebook_2.png)
單擊Run直到3. Test connection
![figure](images/20191008/Jupyter_notebook_3.png)
測試Wifi連線，透過ping命令觀察連線封包
![figure](images/20191008/Jupyter_notebook_4.png)
...
```
password:xilinx
![figure](images/20191008/python.png)

確認Python已安裝套件
```
pip3 list
```
![figure](images/20191008/pip.png)
